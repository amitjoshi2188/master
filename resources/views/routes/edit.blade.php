...
$timing = "";
if (!empty($routeInfo)) {
    $selectedValue =$routeInfo['bus_id'];
    $fromStation =$routeInfo['from_station_id'];
    $toStation =$routeInfo['to_station_id'];
                        ...
                        <div class="row">
                            <div class="col-lg-12 margin-tb">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-primary" href="{{ route('routes.index') }}">
                                        Back</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{ $route->name }}" class="form-control" placeholder="route name">
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" name="timing" value="{{($timing)?? ''}}" id="timing" class="form-control" placeholder="timing">
                                        @error('timing')
                                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                        @enderror
                                    </div>
